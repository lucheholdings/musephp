...
class AttributeContainerAwareMappingFactory extends BaseFactory
{
	...
	{
		$mapping = $this->getAnnotationReader()->getClassAnnotation('Clio\Bridge\Doctrine\Mapping\AttributeContainerAware');
