<?php
namespace Clio\Adapter\SymfonyBundles\OAuth2ServerBundle\Security\Firewall;
...
use Clio\Adapter\SymfonyBundles\OAuth2ServerBundle\Token\Resolver as TokenResolver;
