 ...
 * @license { LICENSE }
 */
class AttributeContainerAwareSubscriber implements EventSubscriberInterface 
{
	...
	public function onPreDeserialize(PreDeserializeEvent $event)
	{
		...
		if(class_exists($type['name'])) {
			...
			if($typeClass->implementsInterface('Clio\Component\Util\Attribute\AttributeContainerAware')) {
