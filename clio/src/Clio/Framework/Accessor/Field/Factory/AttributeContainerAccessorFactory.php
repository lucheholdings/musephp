...
use Clio\Framework\Accessor\Field\AttributeContainerAccessor;
 ...
 * @license { LICENSE }
 */
class AttributeContainerAccessorFactory extends AbstractFieldAccessorFactory
{
	/**
	 * attributeFactory 
	 * 
	...
	public function isSupportedField(Field $field)
	{
		if(($field->getSchema() instanceof ReflectionClassAwarable) && ($field->getSchema()->isReflectionClassAwared())) {
			return $field->getSchema()->getReflectionClass()->implementsInterface('Clio\Component\Util\Attribute\AttributeContainerAware');
		}
	}
