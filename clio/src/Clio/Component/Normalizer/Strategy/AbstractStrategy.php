...
abstract class AbstractStrategy implements Strategy
{
	...
	public function normalize($data, $type = null, Context $context = null)
	{
		...
		if(!$type) {
			...
			throw new \InvalidArgumentException('Strategy requires $type is an instanceof of Clio\Component\Normalizer\Type.');
		}
	...
	public function denormalize($data, $type, Context $context = null)
	{
		...
		if(!$type instanceof Type) {
			throw new \InvalidArgumentException('Strategy required $type as an instanceof of Clio\Component\Normalizer\Type.');
		}
