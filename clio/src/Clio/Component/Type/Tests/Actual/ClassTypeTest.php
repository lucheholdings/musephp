<?php
namespace Clio\Component\Type\Tests\Actual;

use Clio\Component\Type\Tests\TypeTestCase;
use Clio\Component\Type\Actual\ClassType;
...
class ClassTypeTest extends TypeTestCase 
{
    ...
    {
        $type = new ClassType('Clio\Component\Type\Tests\Models\Foo');
    ...
    public function testExtends()
    {
        ...
        $this->assertTrue($type->isName('Clio\Component\Type\Tests\Models\Foo'));
        $this->assertTrue($type->isName('\Clio\Component\Type\Tests\Models\Foo'));
        $this->assertFalse($type->isName('Clio\Component\Type\Tests\Models\FooInterface'));
        $this->assertFalse($type->isName('Clio\Component\Type\Tests\Models\BaseModel'));
        $this->assertFalse($type->isName('Serializable'));

        // isImplements only accept interface
        $this->assertTrue($type->isImplements('Clio\Component\Type\Tests\Models\FooInterface'));
        ...
        $this->assertFalse($type->isExtends('Clio\Component\Type\Tests\Models\FooInterface'));
        $this->assertTrue($type->isExtends('Clio\Component\Type\Tests\Models\BaseModel'));

        // 
        $this->assertFalse($type->isImplements('Serializable'));
        $this->assertFalse($type->isImplements('Clio\Component\Type\Tests\Models\Bar'));
    }
    ...
    {
        return new ClassType('Clio\Component\Type\Tests\Models\Foo');
    }
    ...
    protected function getValidTypes()
    {
        return array(
                ...
                'Clio\Component\Type\Tests\Models\BaseModel',
            );
    }
