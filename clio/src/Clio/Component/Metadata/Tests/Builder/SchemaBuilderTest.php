<?php
namespace Clio\Component\Metadata\Tests\Builder;
...
class SchemaBuilderTests extends \PHPUnit_Framework_TestCase
{
    public function testBuildPrimitive()
    {
        ...
        $this->assertInstanceof('Clio\Component\Type\Type', $metadata->getType());
    ...
    public function testBuildClass()
    {
        ...
        $builder
            ->setName('foo')
            ->setType('Clio\Component\Metadata\Tests\Models\TestModel')
            ->appendProperties()
            ->addField('field1', 'int')
        ;
        ...
        $this->assertEquals('Clio\Component\Metadata\Tests\Models\TestModel', $metadata->getType()->getName());
