...
use Clio\Component\Metadata\Mapping\Factory\Collection as FactoryCollection;
...
class LazyMappingCollection extends Collection
{
	...
	{
		$this->setValueValidator(new SubclassValidator('Clio\Component\Metadata\Mapping'));
	}
