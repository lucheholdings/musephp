...
use Clio\Component\Metadata\Mapping\Collection as MappingCollection;
...
class Collection extends FactoryMap implements NamedFactory 
{
	...
	{
		$this->getStorage()->setValueValidator(new SubclassValidator('Clio\Component\Metadata\Mapping\Factory'));
	}
