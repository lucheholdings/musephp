<?php
namespace Terpsichore\Bundle\OAuth2ServerBundle\Security\Authentication\Provider;
...
use Terpsichore\Bundle\OAuth2ServerBundle\Security\Role\ScopeRoleMap;
use Terpsichore\Bundle\OAuth2ServerBundle\Security\User\OAuth2UserProviderInterface;
