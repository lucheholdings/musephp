<?php
namespace Terpsichore\Bundle\OAuth2ServerBundle\Controller;
...
use Terpsichore\Bundle\OAuth2ServerBundle\Form\AuthorizationForm;
use Clio\Component\Web\Exception as HttpException;

class AuthorizeController extends Controller
{
    /**
     * @var \Terpsichore\Bundle\OAuth2ServerBundle\Model\ClientInterface
     */
    private $client;
    ...
    public function authorizeAction(Request $request)
    {
		...
		if(!$request->isMethod('POST')) {
			...
			$form->setData($data);
			return $this->render('TerpsichoreOAuth2ServerBundle:Authorization:authorize.html.twig', array('form' => $form->createView(), 'client' => $client));
		} else {
			// 
