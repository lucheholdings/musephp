...
class StorageFactory extends InheritComponentFactory 
{
	public function __construct($superClass, array $defaultClasses = array())
	{
		...
		$this->defaultClasses = array_merge(
			array(
				'user_credentials'   => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\UserCredentials',
				'client'             => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\Client',
				'client_credentials' => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\ClientCredentials',
				'access_token'       => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\AccessToken',
				'refresh_token'      => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\RefreshToken',
				'authorization_code' => 'Terpsichore\Bundle\OAuth2ServerBundle\Storage\AuthorizationCode',
			),
			$defaultClasses
		);
	}
