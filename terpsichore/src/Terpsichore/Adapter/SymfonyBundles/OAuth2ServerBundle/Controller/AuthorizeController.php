...
use Terpsichore\Adapter\SymfonyBundles\OAuth2ServerBundle\Form\AuthorizationForm;
use Clio\Component\Web\Exception as HttpException;

class AuthorizeController extends Controller
{
    /**
     * @var \Terpsichore\Adapter\SymfonyBundles\OAuth2ServerBundle\Model\ClientInterface
     */
    private $client;
