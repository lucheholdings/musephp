...
use Clio\Component\Util\Metadata\Schema as SchemaMetadata;
use Clio\Component\Util\Injection\ClassInjector;
use Calliope\Core\Schema\Mapping\SchemaManagerMapping;
...
class SchemaManagerMappingFactory extends AbstractRegistryServiceMappingFactory
{
     ...
     * __construct 
     * 
     * @param Registry $registry Service Registry 
     * @param ManagerClassFactory $managerClassFactory Factory to create Manager from classname 
     * @param string $defaultManagerClass 
     * @access public
     * @return void
     */
	public function __construct(Registry $registry, ManagerClassFactory $managerClassFactory, $defaultManagerClass = 'Calliope\Core\Manager\BasicManager')
	{
	...
	public function getInjector()
	{
		if(!$this->injector) {
			// 
			$this->injector = new ClassInjector('Calliope\Core\Schema\Mapping\SchemaManagerMapping', 'setManagerClassFactory', array($this->getManagerClassFactory()));
		}
    ...
    /**
     * setDefaultManagerClass 
     * 
     * @param mixed $defaultManagerClass 
     * @access public
     * @return void
     */
