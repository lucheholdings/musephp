 ...
 * ProxySchemaProvider 
 * 
 * @uses SchemaProviderInterface
 * @package { PACKAGE }
 * @copyright { COPYRIGHT } (c) { COMPANY }
 * @author Yoshi Aoki <yoshi@44services.jp> 
 * @license { LICENSE }
 */
class ProxySchemaProvider implements SchemaProviderInterface 
{
	/**
	 * reference
	 * 
	 ...
	 * __construct 
	 * 
	 * @param SchemaProviderInterface $reference 
	 * @access public
	 * @return void
	 */
	public function __construct(SchemaProviderInterface $reference)
	{
