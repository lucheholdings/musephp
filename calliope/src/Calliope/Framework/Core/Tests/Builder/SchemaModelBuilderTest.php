 ...
 * @license { LICENSE }
 */
class SchemaModelBuilderTest extends ComponentBuilderTestCase
{
	/**
	...
	{
		return 'Calliope\Framework\Core\Builder\SchemaModelBuilder';
	}
	...
	{
		return $this->getClassMetadataFactory()->create('Calliope\Framework\Core\Tests\TestFlexibleSchemaModel');
	}
