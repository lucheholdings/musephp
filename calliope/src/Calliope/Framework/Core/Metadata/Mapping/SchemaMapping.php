...
;
use Calliope\Framework\Core\Builder\SchemaModelBuilderFactory;
 ...
 * @license { LICENSE }
 */
class SchemaMapping extends AbstractClassMapping
{
    ...
    public function getBuilderFactory()
    {
		if(!$this->builderFactory) {
			// Set default builder
			$this->builderFactory = new SchemaModelBuilderFactory();
		}
