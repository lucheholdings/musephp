 ...
 * @license { LICENSE }
 */
class SchemaModelBuilderFactory extends ComponentFactory implements BuilderFactory
{
	/**
	 * __construct 
	 * 
	...
	{
		if(!$class) {
			$class = 'Calliope\Framework\Core\Builder\SchemaModelBuilder';
		} 
		if(!$class instanceof \ReflectionClass) {
			$class = new \ReflectionClass($class);
		}

		$validationClass = 'Calliope\Framework\Core\Builder\SchemaModelBuilder';
