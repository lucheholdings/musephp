...
use Calliope\Adapter\Doctrine\WebQuery\Condition\Resolver\DoctrineConditionResolver;
/**
 * AdvancedCriteriaSchemeRepository 
 * 
 * @uses AbstractSchemeRepository
 * @package { PACKAGE }
 * @copyright { COPYRIGHT } (c) { COMPANY }
 * @author Yoshi Aoki <yoshi@44services.jp> 
 * @license { LICENSE }
 */
class AdvancedCriteriaSchemeRepository extends AbstractSchemeRepository 
{
	/**
	 * conditionResolver
	 * 
