<?php
namespace Erato\Core\Normalizer\Strategy;
...
use Clio\Component\Util\Accessor\Schema\AccessorRegsitry as SchemaAccessorRegistry;
/**
 * AccessorStrategy 
 * 
 * @uses ObjectStrategy
...
class AccessorStrategy extends ObjectStrategy implements NormalizationStrategy, DenormalizationStrategy
{
	...
	{
		$this->accessorFactory = new ObjectAccessorFactory($accessorRegistry);
	}
